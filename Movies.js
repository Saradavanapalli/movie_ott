...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner" style={{ transitionDuration: "0.1s" }}>
    <div class="carousel-item active">
      <img src={"/images/img3.jpg"} alt="Los Angeles" class="d-block" style={{width:"100%", height: "500px"}}/>
    ...
    <div class="carousel-item">
      <img src={"/images/img2.jpg"} alt="Chicago" class="d-block" style={{width:"100%", height: "500px"}}/>
      <div class="carousel-caption">
        <h3>Chicago</h3>
    ...
    <div class="carousel-item">
      <img src={"/images/img4.jpg"} alt="New York" class="d-block" style={{width:"100%", height: "500px"}}/>
      <div class="carousel-caption">
        <h3>New York</h3>
      ...
      <center><h1 className="text-center" style = {{color:"orange"}}>Horizontal Scrollable Images</h1></center>
       <div className="row flex-nowrap" style={{ overflowX: 'auto', scrollbarWidth: 'none' }}> {/* Use inline styles to hide the scrollbar */}
        <div className="col-md-3">
          <img src="/images/img3.jpg" className="img-fluid" alt="Image 1" />
        </div>
         <div className="col-md-3">
           <img src="/images/img2.jpg" className="img-fluid" alt="Image 2" />
         </div>
         <div className="col-md-3">
           <img src="/images/img3.jpg" className="img-fluid" alt="Image 3" />
         </div>
         <div className="col-md-3">
<img src="/images/img3.jpg" className="img-fluid" alt="Image 3" />
         </div>
